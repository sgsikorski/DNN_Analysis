...
python3 generateProperties.py --instanceCount 10 --onnxFile props/mnist/mnist-net_256x6.onnx --specFile props/mnist/mnist_instances.csv --dataset MNIST --epsilonCount 10

# run neuralsat on all instances

input_file="props/mnist/mnist_instances.csv"

output_file="logs/ns/ns_mnist_output.txt"
> "$output_file"
